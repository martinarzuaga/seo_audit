...
def update_code_ratio(data, wks_velocidad):
    ...
    for i in range(len(data)):
        ...
        html_bytes = int(data[i][1]['data']['median']
                         ['firstView']['breakdown']['html']['bytes'])
        css_bytes = int(data[i][1]['data']['median']
                        ['firstView']['breakdown']['css']['bytes'])
        js_bytes = int(data[i][1]['data']['median']
                       ['firstView']['breakdown']['js']['bytes'])
        img_bytes = int(data[i][1]['data']['median']
